 ...
 *
 * ADR-104 Phase 4: the flat "Menu" section is split into 6 titled
 * sections (OVERVIEW/COMMERCE/CATALOG/CUSTOMERS/PARTNERS/SYSTEM),
 * matching the artifact's own sidebar grouping — every item keeps its
 * exact name/href/icon, this is presentational grouping only, no route
