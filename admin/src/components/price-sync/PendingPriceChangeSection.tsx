          ...
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-gray-800">
              <TableRow>
                ...
                <TableCell isHeader className="px-5 py-3 text-start text-theme-xs font-medium text-gray-500 dark:text-gray-400">Old Cost</TableCell>
                <TableCell isHeader className="px-5 py-3 text-start text-theme-xs font-medium text-gray-500 dark:text-gray-400">Proposed Cost</TableCell>
                <TableCell isHeader className="px-5 py-3 text-start text-theme-xs font-medium text-gray-500 dark:text-gray-400">Swing</TableCell>
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-gray-800">
              {items?.map((p) => (
                <TableRow key={p.id}>
                  ...
                  <TableCell className="px-5 py-4 text-theme-sm text-gray-500 dark:text-gray-400">{p.package.game?.name ?? "—"}</TableCell>
                  <TableCell className="px-5 py-4 text-theme-sm">{formatRm(p.old_cost_price)}</TableCell>
                  <TableCell className="px-5 py-4 text-theme-sm">{formatRm(p.proposed_cost_price)}</TableCell>
                  <TableCell className="px-5 py-4 text-theme-sm text-error-600 dark:text-error-400">
                  ...
                  <TableCell className="px-5 py-4 text-theme-sm">
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" variant="outline" disabled={busyId === p.id} onClick={() => onDismiss(p.id)}>
                        Dismiss
                      </Button>
                    </div>
                  </TableCell>
