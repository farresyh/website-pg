            ...
            <div className="p-5">
              ...
              <div className="mt-6 border-t border-gray-100 dark:border-gray-800 pt-4">
                <SaveButton
                  saving={saving}
                  saved={saved}
                  disabled={!writable || selectedPreset === currentActivePreset}
          ...
          <div className="sticky top-6">
            <Panel title="Live Storefront Preview">
              <div className="p-5">
                ...
                {/* Mockup Frame */}
                <div className="overflow-hidden rounded-xl border-2 border-ink bg-surface p-4 shadow-[4px_4px_0_#19192f]">
                {/* Mockup Header */}
                <div className="flex items-center justify-between border-b-2 border-ink pb-3 mb-4">
                  <div className="flex items-center gap-2">
                    <div
                      className="h-7 w-7 rounded-md border-2 border-ink flex items-center justify-center font-bold text-xs shadow-[1.5px_1.5px_0_#19192f]"
                      style={{
                  ...
                  <span
                    className="rounded-md border-2 border-ink px-2.5 py-1 text-[11px] font-bold shadow-[1.5px_1.5px_0_#19192f]"
                    style={{
                      backgroundColor: activePresetConfig.primaryHex,
                      color: activePresetConfig.tokens["--color-on-primary"],
                    }}
                ...
                {/* Mockup Product Card */}
                <div className="rounded-lg border-2 border-ink bg-white p-3.5 shadow-[3px_3px_0_#19192f]">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <h5 className="mt-1 font-bold text-sm text-ink">
