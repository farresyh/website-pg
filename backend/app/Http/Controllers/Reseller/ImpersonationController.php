 ...
 * `Admin\ResellerImpersonationController::end()` (which an admin uses
 * from `/admin/resellers`); this is the same close, reachable from the
...
class ImpersonationController extends Controller
{
    public function end(Request $request): JsonResponse
    {
        ...
        // check.
        $session = $token === null ? null : ResellerImpersonationSession::query()
        ...
        Log::info('Reseller impersonation ended from portal', ['session_id' => $session->id]);
